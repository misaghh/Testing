var listFormat = false;var ptBaseURI = getptBaseURI();var const_keyCode = { ARRLEFT : 37,ARRUP : 38,ARRRIGHT : 39,ARRDN : 40,ENTER : 13,
 ...
 pthNav.searchURI += "IScript_SESPortalQry";  var asOptions = {
 ...
 var decoded = (encodeURIComponent(htmlDecode(pthNav.unmruCref))); var params = "mrulist=" + encodeURIComponent(mruData)+ "&unmruCref=" + decoded + "&unmruCrefhref=" + encodeURIComponent(pthNav.unmruCrefhref) + sVal;     isAsync = false; var mruLoader = new net2.ContentLoader(ajaxUrl,null,null,"post",function(){},
 ...
 if (!node || 
 !node.parentNode || !node.parentNode.sCfg ||
 typeof(node.parentNode) == "undefined" || 
 typeof(node.parentNode.sCfg) == "undefined") { return; }
 ...
 var inpt = this.addKey(ths[i]); if (inpt && inpt !== 'undefined')
 dTbl.parentNode.parentNode.appendChild(inpt); }
 ...
 var s = pthNav.abn.search; s.isResize = true; var elPopupCont = document.getElementById('ptpopupcontainer'); if (!elPopupCont) 
 elPopupCont = top.document.getElementById('ptpopupcontainer'); if (elPopupCont)
 elPopupCont.setAttribute("oncontextmenu", "return false");; if (!listFormat) {
 ...
 if (browserInfoObj2.isIE && (pthNav.IEquirksMode || s.isIE7) && !browserInfoObj2.isEdge) {
