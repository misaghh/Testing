...
PT_Dialog.prototype = {
 ...
 this.init();      if(typeof oParentWin.modWin != "undefined" && oParentWin.modWin != null && oParentWin.modWin.modalZoomName != null)
 this.closeModalDialog(oParentWin.modWin.modalID); var saveTopModId = MTop().modId; MTop().oParentWin = oParentWin; MTop().modId = this.idCount; this.closeModalMsg(null, this.idCount - 1); modObj = document.createElement("div"); modObj.setAttribute("id", MTop().PTMOD_ + this.idCount); if (typeof msg != "undefined" && msg)
 ...
 var modObj = MTop().document.getElementById(MTop().PTMOD_ + id); if (!modObj) return; var bFluidModal = false; if (typeof modObj.oParentWin.isFModeLayout != "undefined" && modObj.oParentWin.isFModeLayout()) 
 bFluidModal = true; if (modObj.bTypeAhead)
...
function DoURLWarningWithYesNoEvent(url, histElement, backRec, yesEvent, noEvent)
{
 ...
 noEvent = noEvent + "(1,3000);"; var sNo = noEvent ? 'javascript:' + noEvent + 'window.location.href = "' + url + '"' : 'javascript:window.location.href = "' + url + '"'; psConfirmSW(sYes, sNo, window); }
 ...
 window[noEvent](1,3000);  top.location = url; }
 else {
 if ((noEvent != null) && (noEvent.indexOf("processing_") == 0) && (typeof window[noEvent] == 'function'))
 window[noEvent](1,3000);  window.location.href = url; }
}
...
function clearHistoryInternal() 
{
 ...
 if (remoteUrls[i].search("ps://pa") <= 0) {
...
if(messageData.receiverData== "" || messageData.receiverData == "{\"nodes\":[],\"backIndex\":0}")
return;   if ("readHistoryRequest" == messageData.cmdType) {
